...
<#--  ok  -->
    ...
    <#if is_post??>
        ...
        <#--文章目录-->
        <link rel="stylesheet" type="text/css" href="${theme_base!}/source/css/post.css?v=${theme.version!}" />
        ...
        <script src="${theme_base!}/source/js/post_catalog.js?v=${theme.version!}"></script>
